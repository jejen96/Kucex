...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Data User</h1></center>
			</div>
		</div>	
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						   ...
						   <tr>
						    	...
						    	<th data-sortable="true"><center>Nama Lengkap</center></th>
						    	<th data-sortable="true"><center>Alamat Lengkap</center></th>
						    	<th data-sortable="true"><center>Email</center></th>
						    	<th data-sortable="true"><center>Nomor Telepon</center></th>
						        <th data-sortable="true"><center>username</center></th>
						        <th data-sortable="true"><center>Password</center></th>
						        <th data-sortable="true"><center>Rubah</center></th>
						    </tr>
						    </thead>
						    <?php 
							include_once("../Koneksi.php");
							$query_mysql = mysql_query("SELECT * FROM user where Flag='1'")or die(mysql_error());
							$nomor = 1;
							...
							<tr>
								...
								<td>
									<a href="EditDataUser.php?Id_User=<?php echo $data['Id_User']; ?>">Edit</a> 
									<a href="HapusDataUser.php?Id_User=<?php echo $data['Id_User']; ?>">Hapus</a>					
								</td>
							</tr>
							<?php } ?>
						</table>
