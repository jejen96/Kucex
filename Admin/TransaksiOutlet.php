...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header"> Data Transaksi Outlet</h1></center>
			</div>
		</div>	
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						   ...
						   <tr>
							...
							$data = $_GET['Id_Outlet'];
							$query_mysql = mysql_query("SELECT * FROM v_order_user_outlet where Id_Outlet='$data' and Status='Selesai'")or die(mysql_error());
							$nomor = 1;
						...
						<a class="btn btn-primary" href="CetakOutlet.php?Id_Outlet=<?php echo $_GET['Id_Outlet']; ?>">Cetak Transaksi</a>
					</div>
				</div>
			</div>
		</div>
