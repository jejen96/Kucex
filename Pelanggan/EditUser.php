...
<body>
	...
	$id = $_SESSION['Id_User'];
	$query_mysql = mysql_query("SELECT * FROM User WHERE Id_User='$id'")or die(mysql_error());
	$nomor = 1;
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Rubah Data User</h1></center>
			</div>
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
					<center><form role="form" action="UpdateAkun.php" method="post">
						<fieldset>
							<div class="form-group">
								<input type="hidden" class="form-control" name="Id_User" placeholder="Id User" required value="<?php echo $data['Id_User'] ?>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="Nama_Lengkap" placeholder="Nama_Lengkap" required value="<?php echo $data['Nama_Lengkap'] ?>">
							</div>
							<div class="form-group">
