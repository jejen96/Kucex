...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="PesanLaundry.php"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg>Pesan Laundry</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Pesan Zonasi Kucex</h1></center>
			</div>
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
					<center><form role="form" action="PesanAksi.php" method="post">
						<fieldset>
		...
		<div class="footer">
                <p class="copy">Copyright @ 2017 Zonasi Kucex</p>
            </div>	
	</div>
