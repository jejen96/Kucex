...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Data Order Pelanggan</h1></center>
			</div>
		</div>	
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						   ...
						   <tr>
						        ...
						        <th data-sortable="true"><center>Jarak Dari OutLet</center></th>
							...
							$query_mysql = mysql_query(" SELECT * FROM v_order_user_outlet WHERE Id_Outlet='$id' and Status='Order'");
							$nomor = 1;
							...
							<tr>
								<td><?php echo $nomor++; ?></td>
									...
									<td><?php echo $data['Jarak']; echo " KM";?></td>
									<td><?php echo $data['Status']; ?></td>
								<td>
									<a class="btn btn-primary" href="LokasiOrder.php?Id_Order=<?php echo $data['Id_Order']; ?>">Rute</a> 
								</td>

								<td>
									<a class="btn btn-primary" href="Transaksi.php?Id_Order=<?php echo $data['Id_Order']; ?>">Transaksi</a> 				
								</td>
							</tr>
							<?php } ?>
