...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Data Antar Pelanggan</h1></center>
			</div>
		</div>	
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						   ...
						   <tr>
						        ...
						        <th data-sortable="true"><center>Rute</center></th>
						        <th data-sortable="true"><center>Cetak Transaksi</center></th>
						        <th data-sortable="true"><center>Selesai</center></th>
						    </tr>
						    </thead>
						    <?php 
						    $id = $_SESSION['Id_User'];
							include_once("../Koneksi.php");
							$query_mysql = mysql_query("SELECT * FROM v_order_user_outlet WHERE Id_Outlet='$id' and Status='Proses'")or die(mysql_error());
							$nomor = 1;
							...
							<tr>
								...
								<td>
									<a class="btn btn-primary" href="LokasiAntar.php?Id_Order=<?php echo $data['Id_Order']; ?>">Rute</a> 
								</td>
								<td>
									<center><a class="btn btn-primary" href="CetakTransaksi.php?Id_Order=<?php echo $data['Id_Order']; ?>">Cetak</a></center> 
								</td>
								<td>
									<a class="btn btn-primary" href="Selesai.php?Id_Order=<?php echo $data['Id_Order']; ?>">Selesai</a> 		
								</td>
							</tr>
							<?php } ?>
						</table>
